...
Lens Protocol is a blockchain-based open-source social graph created to reshape the future of social media concepts in the era of Web3 and decentralization.

Two core concepts make the Lens Protocol world unique: nonfungible tokens (NFTs) and modularity. Lens Protocol’s decentralized social network members are empowered to create, maintain and own their content and profiles represented through NFTs. With it, Lens Protocol users own their content and data and can utilize them in any social media platform or DApp built on top of the protocol.

It is the first time that users own their data and carry all their social graph with them regardless of which social media they are using. 

  <figure>
    <img src="/assets/lens protocol.png" alt="Lens Protocol" width="80%" height="80%">
    <figcaption>Lens Protocol</figcaption>
  </figure>

Lens Protocol is built on top of the Polygon eco-friendly proof-of-stake (PoS) blockchain to leverage its low gas cost.
...
- Hub：The Hub is an always online server that authenticates, stores, and copies signed messages. Anyone can start the hub server or use a third-party service. Users can also configure his Hub to copy data from other hubs. Followers will then be able to see the latest updates from KOLs.
  ...
  <figure>
    <img src="/assets/Farcaster.png" alt="Farcaster" width="60%" height="60%">
    <figcaption>Farcaster</figcaption>
  </figure>
...
The project was previously called BitClout, and the token was Deso. Here is the Deso ecosystem: https://signup.deso.com/explore
  ...
  <figure>
    <img src="/assets/Deso.png" alt="Deso Explore" width="60%" height="60%">
    <figcaption>Deso Explore</figcaption>
  </figure>
...
- Create tokens and send newsletters only to token holders.
  ...
  <figure>
    <img src="/assets/Paragraph.png" alt="Paragraph" width="50%" height="50%">
...
- AtemReview：Content sharing platform. Creators can create and share their work as Content NFT. Other users can comment and Collect the NFT.
  <figure>
    <img src="/assets/AtemReview.png" alt="AtemReview" width="60%" height="60%">
    <figcaption>AtemReview</figcaption>
  </figure>
...
- AtemChat: The Web3 community social platform allows creators to easily connect and interact with their fans through their NFTs. When users connect the wallet, they will automatically join the NFT Channel supported by the platform. Users can Bid for an NFT directly within the community, and the NFT owner will receive a private message and choose whether or not to accept the offer to complete an NFT transaction.
  <figure>
    <img src="/assets/AtemChat.png" alt="AtemChat" width="60%" height="60%">
    <figcaption>AtemChat</figcaption>
  </figure>
